...
import { Home, Code2, FolderGit2, Mail, User, Menu, X, Download, Briefcase } from "lucide-react";
        ...
        >
          <div className="p-8 space-y-8">
            ...
            <div className="space-y-4 pt-4 border-t border-orange-500/20">
              ...
              <button className="w-full px-6 py-3 rounded-full border-2 border-[#ff6b35] text-[#ff6b35] font-semibold flex items-center justify-center gap-2 hover:bg-[#ff6b35]/10 transition-all duration-300">
