      ...
      <div className="max-w-4xl mx-auto text-center">
        <FadeContent duration={1000} delay={200}>
          <div className="mb-8">
            ...
            {/* Description */}
            <p className={`text-lg md:text-xl max-w-2xl mx-auto leading-relaxed transition-all duration-1000 delay-500 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        ...
        <FadeContent duration={1000} delay={800}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <button className="group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-3 rounded-full hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1">
              <div className="flex items-center space-x-2">
                <Download size={20} className="group-hover:animate-bounce" />
                <span>Download CV</span>
              </div>
            </button>
            <button className={`group border-2 px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 ${
              darkMode 
          ...
          <div className="flex justify-center space-x-6">
            {socialLinks.map(({ Icon, href, label }, index) => (
              <a
                ...
                className={`group p-3 rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-2 ${
                  darkMode 
