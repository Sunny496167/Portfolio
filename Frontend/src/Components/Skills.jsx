        ...
        >
          <div className="mt-20">
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              <div className="h-1 w-20 bg-gradient-to-r from-transparent to-[#ff6b35] rounded-full"></div>
              <h3 className="text-2xl font-bold text-white text-center">
                GitHub Contributions
              </h3>
              <div className="h-1 w-20 bg-gradient-to-l from-transparent to-[#ff6b35] rounded-full"></div>
            </div>

            {/* Calendar Card */}
            <div className="glass-card rounded-3xl p-6 sm:p-8 border-orange-glow flex flex-col items-center justify-center relative overflow-hidden group">
              {/* Top Orange Accent */}
